      ...
      >
        ...
        <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs font-mono text-blue-600 bg-blue-50 px-2.5 py-1 rounded-lg border border-blue-200/80 font-bold truncate max-w-[200px] sm:max-w-xs">
              https://{cleanSlug}.okinsite.com
            </span>
          </div>
